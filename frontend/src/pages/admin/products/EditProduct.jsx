...
import { getProduct, updateProduct } from "../../../services/productApi.js";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        collections: formData.collections, // Always send collections array (even if empty)
      };
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-2">
                    The slug is automatically generated from the product title
                    and is used in the URL. It updates automatically when you
